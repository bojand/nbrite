  ...
  "definitions": {
    "events": {
      ...
      "links": [
        ...
        {
          "description": "Get detains of an access code for an event.",
    ...
    "users": {
      ...
      "links": [
        ...
        {
          "description": "Update a user's venue",
          "href": "/users/{user_id}/venues/{venue_id}/",
          "method": "POST",
          "title": "update",
          "rel": "update",
          "schema": {
        ...
        },
        {
          ...
          "href": "/users/{user_id}/organizers/{organizer_id}",
          "method": "POST",
          "title": "update",
          "rel": "update",
          "schema": {
        ...
        {
          "description": "Retrieve user's organizer.",
